...
export default function SecurityList(props) {
  ...
  const handleEditChange = (securityId) => {
    const data = {
      id: securityId,
      action: 'edit'
    };
  ...
  const handleStatusChange = (securityId) => {
    const data = {
      id: securityId,
      action: 'status'
    }
        ...
        >
          ...
          <div className="block w-full overflow-x-auto overflow-y-auto">
            <table className="items-center w-full bg-transparent border-collapse table-auto">
              ...
              <tbody>
                {props.security.map((security, idx) => {
                  return (<tr key={idx}>
                    ...
                    <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                      <button
                        ...
                        type="button"
                        onClick={() => handleEditChange(security.id)}
                      >
                        Edit
                      </button>
                      <button
                        ...
                        type="button"
                        onClick={() => handleStatusChange(security.id)}
                      >
                        Change Status
                      </button>
                    </td>
